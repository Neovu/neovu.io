...
$(document).ready(function() {
    ...
    $(".btClose").click(function() {
        $('#homePage > section:nth-child(2),#homePage > section:nth-child(3), #homePage > section:nth-child(4)').removeClass('mostra');
        $('.caseOne,.caseTwo, .caseThree').removeClass('white');
    });
    $(".caseOne").click(function() {
        $("#homePage > section:nth-child(2)").toggleClass("mostra", 500, "swing");
        $('#homePage > section:nth-child(3), #homePage > section:nth-child(4)').removeClass('mostra');
        listaHomePage.not(this).removeClass('white');
        return false;
    });
    $(".caseTwo").click(function() {
        $("#homePage > section:nth-child(3)").toggleClass('mostra', 1000, "swing");
        $('#homePage > section:nth-child(2), #homePage > section:nth-child(4)').removeClass('mostra');
        listaHomePage.not(this).removeClass('white');
        return false;
    });
    $(".caseThree").click(function() {
        $("#homePage > section:nth-child(4)").toggleClass('mostra', 500, "swing");
        $('#homePage > section:nth-child(2), #homePage > section:nth-child(3)').removeClass('mostra');
        listaHomePage.not(this).removeClass('white');
        return false;
    });
    ...
    // BG-IMG ANIMATION
    $('#metodologia[data-type="background"],#labContent[data-type="background"]').each(function() {
        var $bgobj = $(this);
        $(window).scroll(function() {
